...
export const handDiagramTourSteps = [
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Click/tap and drag on the hand diagram to shade the areas where you feel this symptom. Lift your mouse or finger to finish drawing.',
      side: 'right',
      align: 'start'
    }
  },
...
export const handDiagramTourConfig = {
  ...
  stagePadding: 10,
  stageRadius: 8,
  allowClose: false,  // Prevent closing without completing
