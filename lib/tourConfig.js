...
// Tour steps for Section 0: Diagnostic Questions
export const questionsTourSteps = [
  {
    element: '#diagnostic-header',
    popover: {
      title: 'Diagnostic Questions',
      description: 'Answer these questions based on your symptoms over the <strong>last month</strong>. All questions are required before proceeding.',
      side: 'bottom',
      align: 'start'
    }
  }
...
export const handDiagramTourSteps = [
  {
    element: '#symptom-section-tingling',
    popover: {
  ...
  {
    element: '#canvas-tinglingFrontLeft',
    popover: {
  ...
  {
    element: '#back-view-section-tingling',
    popover: {
      title: 'Back of Hand',
  ...
  {
    element: '#clear-btn-tinglingFrontLeft',
    popover: {
      title: 'Clear & Redraw',
